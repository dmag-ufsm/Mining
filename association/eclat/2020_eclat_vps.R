...
write(rules_media, file = paste("eclat_rules_pontos_media_", players, "players_", suporte, ".csv", sep = ''), sep = ';', quote = FALSE, row.names = FALSE)
write(rules_1quartil, file = paste("eclat_rules_pontos_1quartil_", players, "players_", suporte, ".csv", sep = ''), sep = ';', quote = FALSE, row.names = FALSE)
write(rules_3quartil, file = paste("eclat_rules_pontos_3quartil_", players, "players_", suporte, ".csv", sep = ''), sep = ';', quote = FALSE, row.names = FALSE)

write(rules_sub_media, file = paste("eclat_rules_pontos_sub_media_", players, "players_", suporte, ".csv", sep = ''), sep = ';', quote = FALSE, row.names = FALSE)
write(rules_sub_1quartil, file = paste("eclat_rules_pontos_sub_1quartil_", players, "players_", suporte, ".csv", sep = ''), sep = ';', quote = FALSE, row.names = FALSE)
write(rules_sub_3quartil, file = paste("eclat_rules_pontos_sub_3quartil_", players, "players_", suporte, ".csv", sep = ''), sep = ';', quote = FALSE, row.names = FALSE)
